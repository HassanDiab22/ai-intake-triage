...
- Replace JSON storage with a database (PostgreSQL)
- Add async processing (queue-based architecture)
- Introduce prompt versioning and evaluation
- Support multi-currency billing validation
